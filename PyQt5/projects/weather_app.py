...
class WeatherApp(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("../resources/weather.png"))
    ...
    def initUI(self):
        ...
        # stylesheet
        self.setStyleSheet("""
            QLabel, QPushButton {font-family: Calibry;}
            QLabel#city_label {font-size: 30px; font-style: Italic}
    ...
    def get_weather(self):
        api_key ="bf8f9a14c41d790c23ae1b639ffbb39d"
        ...
        try:
            ...
            match response.status_code:
                ...
                case 503:
                    self.display_error("Service Unvavailable:\nServer is down")
                case 504:
